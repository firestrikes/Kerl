      ...
      <table>
        ...
        ?>
            <tr>
              ...
              <td>
                <select name="attendance[<?php echo $row['student_id']; ?>]" required>
                  <option value="1" <?php echo ($row['attendancestatus_id'] == 1) ? 'selected' : ''; ?>>Present</option>
                  <option value="2" <?php echo ($row['attendancestatus_id'] == 2) ? 'selected' : ''; ?>>Absent</option>
                  <option value="3" <?php echo ($row['attendancestatus_id'] == 3) ? 'selected' : ''; ?>>Tardy</option>
                </select>
              </td>
            </tr>
        <?php 
